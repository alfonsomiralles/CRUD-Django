...
def create(request):
    art1 = Article(headline="Noticias de las 1")
    art1.save()
    art2 = Article(headline="Noticias de las 2")
    art2.save()
    art3 = Article(headline="Noticias de las 3")
    art3.save()
    ...
    pub3.save()
    pub4 = Publication(title="Publicación 3")
    pub4.save()
    pub5 = Publication(title="Publicación 3")
    pub5.save()
    pub6 = Publication(title="Publicación 3")
    pub6.save()
    pub7 = Publication(title="Publicación 3")
    pub7.save()
